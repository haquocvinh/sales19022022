...
class OrderResponse {
  ...
  @override
  String toString() {
    return 'OrderResponse{idCustomerOa: $idCustomerOa, idCustomer:$idCustomer, carts: $Carts, totalAmount: $totalAmount}';
  }
...
class Carts {
  ...
  @override
  String toString() {
    return 'OrderResponse{idProduct: $idProduct, quantity: $quantity, checked: $checked, type: $type}';
  }
